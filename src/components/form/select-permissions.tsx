...
import { getOptionsPermission } from "@/actions/permission";
...
const SelectPermissions = ({
  ...
  useEffect(() => {
    ...
    const fetchOptions = async () => {
      try {
        const optionPermissions = await getOptionsPermission();
        if (optionPermissions) {
          const mappedOptions = optionPermissions.map((permission) => ({
