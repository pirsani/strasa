...
interface DataDukungUangHarianLuarNegeriProps {
  kegiatanId: string;
  editId?: number | null;
}
const DataDukungUangHarianLuarNegeri = ({
  editId,
  kegiatanId,
}: DataDukungUangHarianLuarNegeriProps) => {
...
export default DataDukungUangHarianLuarNegeri;
